export const GameData = {
    hulls: { 
        "hunter": { name: "Охотник", hp: 150, armor: { front: 60, side: 30, rear: 20 }, speed: 50, size: {w: 80, h: 60}, hitbox: {w: 70, h: 52}, ability: "Нет", cost: 0 },
        "leopard": { name: "Леопард", hp: 120, armor: { front: 40, side: 40, rear: 40 }, speed: 65, size: {w: 80, h: 60}, hitbox: {w: 66, h: 46}, ability: "Защитный дрон", cost: 15 },
        "titan": { name: "Титан", hp: 180, armor: { front: 70, side: 60, rear: 30 }, speed: 44, size: {w: 80, h: 60}, hitbox: {w: 74, h: 54}, ability: "Мина-паук", cost: 15 }
    },
    turrets: { 
    ...
    enemyHulls: { 
        ...
        // ОБНОВЛЕНО: Добавлен корпус Демона
        "demon": { name: "Демон", hp: 120, armor: { front: 40, side: 30, rear: 10 }, speed: 55, size: {w: 80, h: 60}, hitbox: {w: 72, h: 50} }
    },
    enemyTurrets: { 
        ...
        // ОБНОВЛЕНО: Добавлена башня Демона (Урон 90, Перезарядка 3с)
        "demon": { name: "Демон-Пушка", fireRate: 3.0, penetration: 90, burstCount: 1, burstDelay: 0, bulletRadius: 3.5, bulletColor: '#ff0000', shootSound: 'cannon' }
    }
};
...
export const LevelsConfig = { 
    ...
    // ОБНОВЛЕНО: Добавлен 4-й уровень

...
function startLevel(levelNum) {
    ...
    playerTank = new Tank(500, 350, playerImages.hulls[hullId], playerImages.turrets[turretId], GameData.hulls[hullId], GameData.turrets[turretId], currentHp);
...
function gameLoop(timestamp) {
    ...
    if (playerTank.hp <= 0 && !levelFinished) { 
        levelFinished = true; 
        const hullId = PlayerProgress.currentAssembly.hullId;
        PlayerProgress.hullsHp[hullId] = Math.floor(GameData.hulls[hullId].hp * 0.2); 
